...
public class Iglesias {
    ...
    /** Realiza una busqueda de iglesias cuyos nombres contengan de forma parcial o total
     * el String (texto) especificado.
     * @param nombre Fragmento o nombre completo de la iglesia por el cual se desea realizar el filtro.
     * @return Un array de enteros que contiene los indices de todas las iglesias que coincidieron 
     ...
     * Valida que no exceda el limite del almacenamiento y que el codigo no este duplicado.
    ...
    /**
     * Modifica la informacion de una iglesia (nombre, direccion y aforo) buscando por su codigo.
    ...
    /**
     * Imprime en la consola la informacion basica de una iglesia (Nombre y Direccion)
    ...
    /**
     * Imprime en la consola la informacion completa de una iglesia (Codigo, Nombre, Direccion y Aforo)
     * por su posicion en el arreglo.
     * @param indice Posicion de la iglesia dentro de los arreglos.
     */
