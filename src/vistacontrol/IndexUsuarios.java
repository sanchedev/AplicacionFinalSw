...
public class IndexUsuarios {
    ...
    private static void editarPerfil() {
        ...
        int indice = Usuarios.buscarUsuario(email);

        String nombre = Lector.preguntar("Nombre Completo", Usuarios.verNombre(indice));
        String nuevaContra = Lector.preguntar("Contrasenia", contrasenia);
    ...
    private static void registrarUsuario() {
        ...
        if (Lector.confirmar("¿Desea notificar al nuevo usuario sobre su cuenta?")) {
            String saludo = String.format("¡Hola %s, bienvenido!", nombre);
            String seguridad = "Tu cuenta ha sido creada correctamente. Por seguridad, tu contraseña no se envía por este medio.";
            String cierre = "Ya puedes iniciar sesión con las credenciales que acabas de definir.";

            // (%0D%0A es el salto de línea en URI)
            String cuerpo = String.format("""
                                          ...
                                          !! IMPORTANTE: Por favor, cambia tu contrasenia inmediatamente despues de iniciar sesion.
            ...
            Correo.abrirClienteCorreo(
                    email,
                    "Creación de cuenta exitosa - " + nombre,
                    cuerpo
            );
        }
    }
